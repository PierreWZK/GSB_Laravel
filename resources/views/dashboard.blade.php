<x-app-layout>
    ...
    <div class="py-9">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg text-center text-black">
                <div class="p-6 bg-white border-b border-gray-200 text-center" style="text-align: center;">
                    <h1>LABORATOIRE GALAXY SWISS BOURDIN</h1>
                </div>
                <section class="hero container max-w-screen-lg mx-auto text-center pb-8 pt-8">
                    <div>
                        <img src="images/1.png" alt="GSB" class="place-item-center mb-3">
                    </div>
                </section>
