...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 04 avr. 2022 à 12:11
...
CREATE TABLE IF NOT EXISTS `rapport_visite` (
  ...
  `RAP_MOTIF` varchar(90) DEFAULT NULL,
  PRIMARY KEY (`RAP_NUM`),
...
('zzz', 1, 3, '2022-03-01T00:00', 'Analyse, Réanimation, TOTALE', 'Hémorragie interne au niveau du cerveau'),
('zzz', 2, 12, '2022-03-17T22:00', 'Aucun rapport : RAS', 'Fracture du péroné'),
...
('zzz', 5, 12, '2022-03-27T16:00', 'Début de la rééducation', 'Mal de pied'),
('zzz', 6, 9, '2022-03-26T19:00', 'RAS, Bandage au bras', 'Ouverture profonde au niveau du bras'),
('a131', 7, 41, '2003-03-23 00:00:00', 'RAS\r\nChangement de tel : 05 89 89 89 89', 'Rapport Annuel'),
('zzz', 8, 41, '2022-03-28T18:00', 'Analyse de sang a refaire', 'Taux de glissémie beaucoup trop élevé'),
('zzz', 12, 74, '2020-03-06 00:00:00', '', 'Cancer du crane'),
('zzz', 13, 14, '2022-03-26T23:00', 'Radio sur avant jambe gauche', 'Déchirure du muscle de la jambe avant gauche'),
('zzz', 23, 1, '2022-03-04T10:55', 'Renouvellement de médicaments', 'Médicament'),
('zzz', 24, 1, '2022-03-04T10:55', 'Renouvellement de médicaments', 'Médicaments renouvellement avec Pharmacie');
...
--
ALTER TABLE `offrir`
  ADD CONSTRAINT `offrir_ibfk_1` FOREIGN KEY (`VIS_MATRICULE`) REFERENCES `visiteur` (`VIS_MATRICULE`),
  ADD CONSTRAINT `offrir_ibfk_2` FOREIGN KEY (`RAP_NUM`) REFERENCES `rapport_visite` (`RAP_NUM`),
  ADD CONSTRAINT `offrir_ibfk_3` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `medicament` (`MED_DEPOTLEGAL`);
...
ALTER TABLE `rapport_visite`
  ...
  ADD CONSTRAINT `rapport_visite_ibfk_2` FOREIGN KEY (`PRA_NUM`) REFERENCES `praticien` (`PRA_NUM`);
